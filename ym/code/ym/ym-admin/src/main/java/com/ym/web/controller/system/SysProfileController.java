...
import com.ym.common.utils.file.MimeTypeUtils;
import com.ym.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(YmConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
